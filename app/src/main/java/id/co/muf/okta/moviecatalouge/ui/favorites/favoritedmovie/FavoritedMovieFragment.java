...
public class FavoritedMovieFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_favorited_movie, container, false);
    }
...
//            courses = viewModel.getBookmarks();
            ...
            adapter = new FavoritedMoviePagedAdapter();
    ...
    @NonNull
    private static FavoritedMovieViewModel obtainViewModel(FragmentActivity activity) {
        // Use a Factory to inject dependencies into the ViewModel
        ViewModelFactory factory = ViewModelFactory.getInstance(activity.getApplication());
        return ViewModelProviders.of(activity, factory).get(FavoritedMovieViewModel.class);
    }
